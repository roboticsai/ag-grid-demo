  ...
  const [showPinSubmenu, setShowPinSubMenu] = useState('hidden')
    ...
    return (
      <>
        ...
        <div className={`${showPinSubmenu} flex flex-col subnav-content p-4 rounded-lg bg-gray-50 dark:bg-gray-800`} aria-labelledby="dashboard-tab">
