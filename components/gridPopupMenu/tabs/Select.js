...
export default function Select({visibility, columns, setActiveColumns}) {
    ...
    return (
        <form className={`${visibility} h-1/2 items-center mb-4 bg-white border border-black-100`}>
            <ul className="overflow-auto py-2 text-sm text-gray-700 dark:text-gray-200 p-1">{listItems}</ul>
        </form>
    )
}